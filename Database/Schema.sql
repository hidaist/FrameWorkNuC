...
-- Dumping database structure for frameworkbydmz
CREATE DATABASE IF NOT EXISTS `frameworkbydmz` /*!40100 DEFAULT CHARACTER SET utf8mb3 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `frameworkbydmz`;

-- Dumping structure for table frameworkbydmz.tb_data
